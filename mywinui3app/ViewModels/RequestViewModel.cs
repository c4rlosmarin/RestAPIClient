    ...
    public void InitializeExistingRequest(RequestItem request)
    {
        ...
        switch (request.RequestId)
        {
            case "975b53b7-f48f-4682-8434-893f5a324278":
                ...
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="list", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                ...
                Headers = new ObservableCollection<HeaderItem>(){
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. Specifies the version of the operation to use for this request.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "e192945c-7d70-49c6-8e50-521a2f7f01c2":
                ...
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="service", Description="restype=service&comp=properties | Required. The combination of both query strings is required to set the storage service properties.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="properties", Description = "restype=service&comp=properties | Required. The combination of both query strings is required to set the storage service properties." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds" , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "9cc6eb22-c1d3-4ee0-b076-b4c58d4feb17":
                ...
                TabIconVisibility = "Collapsed";
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() { new(_messenger) { IsEnabled = false, Key = "timeout", Description = "Optional. The timeout parameter is expressed in seconds", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true" } };
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. Specifies the version of the operation to use for this request.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "30e6c366-35d0-47e5-9a5c-def2ee2cfe31":
                ...
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="service", Description="Required. The restype parameter value must be account.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="properties", Description = "Required. The comp parameter value must be properties." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. Specifies the version of the operation to use for this request.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "53d9941c-dcc4-48b8-a717-24064108ecda":
                ...
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="service", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="userdelegationkey", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description = "Optional. The timeout parameter is expressed in seconds", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true" }};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "042368e5-65ec-4a73-8462-86b65be8c353":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="container", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds" , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "2117dd4c-e41f-4c15-b5c3-2b266ca3c225":
                ...
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="container", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="metadata", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds" , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "4944ad75-ad15-4ae2-bfd7-79d8051c427c":
                ...
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="container", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="acl", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds" , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "76dbc6cf-f1ba-49af-ac15-b0447114d933":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="container", Description="Required. The restype parameter value must be container.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="undelete", Description="Required. The comp parameter value must be undelete.", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds" , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                ...
                new(_messenger) { IsEnabled = true, Key = "x-ms-deleted-container-name", Description = "Required. You use this header to uniquely identify the soft-deleted container that should be restored.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "5a0ff8b0-02f2-4d62-be05-aa2f2f83cd92":
                ...
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "restype", Value="container", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "comp", Value="blobs", DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "where", Value="expression", Description="Required. Filters the result set to include only blobs whose tags match the specified expression." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                ...
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests, but optional for anonymous requests. Specifies the version of the operation to use for this request.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "x-ms-client-request-id", Description = "Optional. Provides a client-generated, opaque value with a 1-kibibyte (KiB) character limit that's recorded in the logs when logging is configured. We highly recommend that you use this header to correlate client-side activities with requests that the server receives.",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                IsBodyComboEnabled = "false";
                SelectedBodyType = "None";
            ...
            case "acbdfae5-c66b-44ea-8d89-6b5ff4b27e8e":
                ...
                new(_messenger) { IsEnabled = true, Key = "x-ms-blob-type", Description = "Required. Specifies the type of blob to create, which must be BlockBlob. If the blob type isn't BlockBlob, the operation fails with status code 400 (Bad Request).", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "a4d7a27b-670d-4ad4-8168-f81db1a9a0dd":
                ...
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "186bbfdd-abcb-4003-9efe-6504986bcff5":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="properties", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "d992088f-86b7-4268-a697-a1e7ec719fb4":
                ...
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="tags", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "snapshot", Description="Optional. The snapshot parameter is an opaque DateTime value that, when it's present, specifies the blob snapshot to retrieve. For more information about working with blob snapshots, see Create a snapshot of a blob.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "b2dde2c7-86ec-4667-a5db-8c75118f175a":
                ...
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. Specifies the version of the operation to use for this request. For more information, see Versioning for the Azure Storage services.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "Content-Length", Description = "Required. The length of the request content in bytes. This header refers to the content length of the tags document, not of the blob itself.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "Content-Type", Description = "Required. The value of this header should be application/xml; charset=UTF-8.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "061c4c88-981e-482f-bbd8-356f3594484c":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="lease", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "bf386510-9394-4720-8769-b712a6ea08fb":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="snapshot", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "8f5e0e97-744c-4218-bdd3-8f45ea545e95":
                ...
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. For more information, see Versioning for the Azure Storage services.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "9487af8f-941f-40c0-8671-98e8a461d0ad":
                ...
                new(_messenger) { IsEnabled = true, Key = "x-ms-requires-sync", Description = "Required. Indicates that this is a synchronous Copy Blob From URL operation instead of an asynchronous Copy Blob operation.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "ba127e8f-faee-4c97-9a5f-908e3f5b3a2c":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="copy", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "copyid", Value="<id>", Description="Replace <id> with the copy identifier provided in the x-ms-copy-id header of the original Copy Blob operation.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-version", Description = "Required for all authorized requests. For more information, see Versioning for the Azure Storage services.", DatePickerButtonVisibility="Visible",DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-copy-action", Value="abort", Description = "Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "799b6e8b-3aab-4521-9507-2fec5b7e894a":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="undelete", Description="Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "16744da0-054b-4fea-baee-2a8c0e4ee36f":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="tier", Description="Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                ...
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Setting timeouts for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
                new(_messenger) { IsEnabled = true, Key = "Authorization", Description = "Required. Specifies the authorization scheme, storage account name, and signature. For more information, see Authorize requests to Azure Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "x-ms-date", Description = "Required. Specifies the Coordinated Universal Time (UTC) for the request. For more information, see Authorize requests to Azure Storage.", UTCVisibility="Visible", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "27400b89-4193-4804-9c97-8fc98bd4ec73":
                ...
                TabMethodForegroundColor = foregroundColorHelper.POST;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="batch", Description="Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                ...
                new(_messenger) { IsEnabled = true, Key = "Content-Length", Description = "Required. The length of the request.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "Content-Type", Description = "Required. The value of this header must be multipart/mixed, with a batch boundary. Example header value: multipart/mixed; boundary=batch_a81786c8-e301-4e42-a729-a32ca24ae252.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "x-ms-client-request-id", Description = "Optional. Provides a client-generated, opaque value with a 1-kibibyte (KiB) character limit that's recorded in the logs when logging is configured. We highly recommend that you use this header to correlate client-side activities with requests that the server receives. For more information, see Monitor Azure Blob Storage.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                IsBodyComboEnabled = "false";
            ...
            case "965b3e05-3adc-4413-ba39-cf82ab6e26db":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="immutabilityPolicies", Description="Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "2548c991-90c9-4159-98a8-c6d076787b01":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "comp", Value="legalhold", Description="Required", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "snapshot", Description="Optional. The snapshot parameter is an opaque DateTime value that, when present, specifies the blob snapshot to set a tier on. For more information about working with blob snapshots, see Create a snapshot of a blob", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "versionid", Description="Optional for version 2019-12-12 and later. The versionid parameter is an opaque DateTime value that, when present, specifies the version of the blob to set a tier on.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. The timeout parameter is expressed in seconds. For more information, see Set time-outs for Blob Storage operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
            ...
            case "6ccb4aba-4209-4192-aa87-a0c24f9e26bf":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "resource", Value="filesystem", Description="Required. The value must be \"filesystem\" for all filesystem operations.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "232cc021-77e1-4b8e-a7cd-88bd8d1434c7":
                ...
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "resource", Value="account", Description="Required. The value must be \"account\" for all account operations.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "e71bf0b4-b2eb-4325-a8f0-d51d402124c7":
                ...
                URL = new URL() { RawURL = "https://{accountName}.{dnsSuffix}/{filesystem}?resource=filesystem" };
                SelectedMethod = new MethodsItemViewModel() { Name = "PATCH" };
                IsMethodComboEnabled = "false";
                TabIconVisibility = "Collapsed";
                TabMethodForegroundColor = foregroundColorHelper.PATCH;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "resource", Value="account", Description="Required. The value must be \"account\" for all account operations.", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = false, Key = "timeout", Description="Optional. An optional operation timeout value in seconds. The period begins when the request is received by the service. If the timeout value elapses before the operation completes, the operation fails." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"}};
                Headers = new ObservableCollection<HeaderItem>() {
            ...
            case "b418189f-0b7e-4e5d-a85f-5305eea05bd7":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PUT;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = false, Key = "resource", Value="", Description="Required only for Create File and Create Directory. The value must be \"file\" or \"directory\".", DeleteButtonVisibility="Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "b9bbf718-1be0-4d6e-b6ca-941af99a1383":
                ...
                TabMethodForegroundColor = foregroundColorHelper.GET;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "recursive", Value="{recursive}", Description="Required. If \"true\", all paths are listed; otherwise, only paths at the root of the filesystem are listed. If \"directory\" is specified, the list will only include paths that share the same root." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
                new(_messenger) { IsEnabled = true, Key = "resource", Value="filesystem", Description="Required. The value must be \"filesystem\" for all filesystem operations." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
            ...
            case "9f787102-8ff4-419b-af44-de620d842ebc":
                ...
                TabMethodForegroundColor = foregroundColorHelper.PATCH;
                Parameters = new ObservableCollection<ParameterItem>() {
                new(_messenger) { IsEnabled = true, Key = "action", Value="{action}", Description="Required. The action must be \"append\" to upload data to be appended to a file, \"flush\" to flush previously uploaded data to a file, \"setProperties\" to set the properties of a file or directory, or \"setAccessControl\" to set the owner, group, permissions, or access control list for a file or directory, or \"setAccessControlRecursive\" to set the access control list for a directory recursively. Note that Hierarchical Namespace must be enabled for the account in order to use access control. Also note that the Access Control List (ACL) includes permissions for the owner, owning group, and others, so the x-ms-permissions and x-ms-acl request headers are mutually exclusive." , DeleteButtonVisibility = "Collapsed", IsKeyReadyOnly = "true", IsDescriptionReadyOnly = "true"},
